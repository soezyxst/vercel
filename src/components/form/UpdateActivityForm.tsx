...
const UpdateActivityForm = ({
  ...
  const updateActivity = api.activity.updateActivity.useMutation({
    onSuccess: async () => {
  ...
  const { data } = api.activity.getActivityById.useQuery({ id: id! });
  ...
  const onSubmit: SubmitHandler<CreateActivityFormProps> = async (data, e) => {
    ...
    await updateActivity.mutateAsync({
      ...
      startTime: (data.startTime as Date) ?? undefined,
      endTime: (data.endTime as Date) ?? undefined,
    });
    reset();
    onClose();
  };
